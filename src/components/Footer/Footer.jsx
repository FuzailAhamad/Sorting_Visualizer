    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-text">
          ...
          <p>Designed and developed by @Fuzail Ahamad</p>
        </div>
        <div className="footer-icons">
          <a href="https://github.com/FuzailAhamad" target="_blank" rel="noopener noreferrer">
          ...
          <a href="www.linkedin.com/in/fuzail-ahamad" target="_blank" rel="noopener noreferrer">
